...
- **Refaturamento** — reemissão de nota fiscal para o mesmo pedido; `Permitido`/`Proibido`/`Sem Referência`. Semântica de dedução (G6) difere entre vendas (sempre deduz) e faturamento (só deduz se não-Permitido) desde 14/09/2026.
...
- **Setor irrestrito** — flag de usuário que ignora o escopo por setor do RH. Ver [[RH-Escopo-Row-Level-Security]].
