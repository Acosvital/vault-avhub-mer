...
1. **7 das 11 decisões (DEC-3, DEC-4, DEC-5, DEC-6, DEC-8, DEC-9, DEC-10, DEC-11) seguem sem registro no vault.** DEC-1, DEC-2 e DEC-7 já foram decididas em 21/09 (Nathan+Robert na DEC-1; Nathan+Robert+Gustavo na DEC-2; Gustavo na DEC-7, os 4 sub-itens resolvidos) — ver [[MES-Arquitetura-Decisoes]] itens 7-8 e [[Indice-Contratos]]; **C2, a escrita da spec F1, e B3/B5/D1/D3 estão destravados**. Só **DEC-4** ainda trava a D1 (início amanhã). Lista com prazo e default em [[Perguntas-em-Aberto-Consolidadas]].
