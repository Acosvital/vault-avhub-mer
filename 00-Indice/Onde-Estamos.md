...
1. **4 das 11 decisões (DEC-4, DEC-6, DEC-8, DEC-10) seguem sem registro no vault.** DEC-1, DEC-2, DEC-3, DEC-5, DEC-7, DEC-9 e DEC-11 já foram decididas em 21/09 — ver [[Decisoes-Chave-ERP]] e [[MES-Arquitetura-Decisoes]] itens 7-8; **C2, E2, D6/D7, a escrita da spec F1, e B3/B5/D1/D3 estão destravados**. Só **DEC-4** ainda trava a D1 (início amanhã). **DEC-8 (hardware) segue explicitamente adiada** pelo Nathan, não é esquecimento; **DEC-11 (financeiro nativo) decidida como fora do roadmap atual**, revisitar só quando o Omie for desligado. Lista com prazo e default em [[Perguntas-em-Aberto-Consolidadas]].
