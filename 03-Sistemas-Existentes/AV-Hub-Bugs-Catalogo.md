...
Essas 2 ainda não foram exploradas em profundidade. A mera existência da rota já muda o "custo estimado" dessas features de "caro/precisa contrato novo" para "possivelmente só falta plugar no frontend". Vale investigar antes de re-priorizar o roadmap do Portal do Vendedor.
