...
Terceiro repositório recebido nesta rodada — o extrator que alimenta o dado cru que sustenta [[AV-Hub-Vendas-Reconciliacao|toda a reconciliação de vendas]]. Node.js/TypeScript, `pg` puro (sem ORM), BullMQ+Redis, `node-cron`, Playwright.
