...
⚠️ **Corrigido nesta rodada** — antes atribuído direto ao Comprador; na prática é o **CCP** quem faz esse acompanhamento ativo (cobrar prazo, atualizar previsão), enquanto o comprador já seguiu pra outras compras. Canal externo (telefone/e-mail/WhatsApp), registrado manualmente. **Não existe estado "em trânsito" verificável** — o pedido permanece "Aprovado" até a chegada física (achado já documentado em [[Rota-Revenda]]).
...
**C7b/C8 (FOB) ou C8b (CIF) — Logística de entrada, corrigido**
⚠️ **Setor que estava faltando por completo, e termo corrigido nesta rodada** (era "coleta própria ou frete CIF" — errado; o par correto é **CIF × FOB**, dois incoterms que definem quem paga e quem é responsável pelo transporte, não uma escolha de "quem busca"):
...
Já citado (sem a distinção correta) em [[Rota-Revenda]], corrigido nesta rodada.
...
Aprova ou reprova. Reprovação exige motivo + evidência (ex.: foto de avaria, achado dos áudios do gerente — ver [[Fluxo-Detalhado-Pedido-Item]]).
