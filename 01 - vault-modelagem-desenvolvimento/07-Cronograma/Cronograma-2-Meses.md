...
> Plano fechado em **42 dias úteis** (61 corridos, com os feriados de 12/10 e 02/11), montado em cima do que o vault já decidiu: as fases 0/A/B/C de [[Estoque-Roadmap]], o roteiro de extração do Omie, os contratos do vault 04 e o fluxo dos 6 fluxogramas de [[Fluxogramas-Completos]].
>
...
Cada uma tem um *default* escrito: se ninguém decidir até a data, o default vale e a decisão vira registro no vault. Nenhuma dessas decisões é nova — são as perguntas já abertas em [[Perguntas-Pendentes-MES-Estoque]], [[Estoque-Perguntas-Abertas]] e nos contratos do vault 04, datadas.
