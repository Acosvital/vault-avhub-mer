...
- Cadastro de material (MP e revenda), pedido de compra. Não inclui cadastro próprio de fornecedor — reaproveita `core.parceiros` (av-hub) via projeção read-only, ver [[Estoque-Modelo-Dados]] e [[MES-Arquitetura-Decisoes]].
