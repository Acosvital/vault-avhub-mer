...
| ID | Pergunta | Quem |
|---|---|---|
| N-02 | ~~Nome definitivo do sistema de fábrica ("MES Aços Vital" é nome de trabalho)~~ ✅ **RESPONDIDO em 22/09/2026**: o nome é **MES** — aceito por ora, com abertura para trocar no futuro. | Nathan |
