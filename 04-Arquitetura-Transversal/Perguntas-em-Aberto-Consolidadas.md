...
Estas **não têm resposta** — continuam precisando de uma pessoa decidir — mas o levantamento contra o dump/código real e os documentos de API do Omie já traz evidência concreta, então a conversa não precisa começar do zero. (R-01, R-06, G-16, M-01 e N-03 saíram daqui em 21/09 — já respondidas, ver blocos B/C/D/E.)
