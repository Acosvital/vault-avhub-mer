...
- [x] **Identidade/autorização — decidido que será múltipla (16/09).** 2 implementações reais: av-hub e MES (Estoque+Fabricação juntos). A proposta de grupos do Azure AD do PRD do Estoque original segue descartada. Ver [[Achado-Duplicacao-RBAC]] e [[MES-Arquitetura-Decisoes]].
