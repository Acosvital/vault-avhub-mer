...
# Contradição encontrada: CFOP já é capturado, apesar do que o vault 01 documenta

## O que o vault 01 afirma

Em três lugares diferentes (`Estoque-Regras-Negocio.md`, `Fluxo-Recebimento-Completo.md`, `Estoque-Modelo-Dados.md`) o vault 01 registra que CFOP e ICMS-ST **não são capturados por nenhum sistema** — "fica 100% com o Omie".
...
Corrigir a afirmação no vault 01 (`Estoque-Regras-Negocio.md`, `Fluxo-Recebimento-Completo.md`, `Estoque-Modelo-Dados.md`) para refletir que CFOP de venda **já está disponível por item**, mantendo apenas ICMS-ST como de fato não capturado.
