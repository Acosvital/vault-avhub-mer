...
## Por que isso importa para o vault 01

O Portal do Vendedor (vault 01, `AV-Hub-Portal-Vendedor-Plano.md`) tem um "dicionário de nomes de etapa" pendente. Essa tabela é a candidata natural para resolver isso, e a NF já tem um cruzamento pronto via `notas_fiscais.oppedido` → `codigo_operacao` (ver [[Notas-Fiscais-e-Itens]]).
