...
Complementa a nota já existente no vault 01 (`Omie-ELT-Pipeline.md`) com o essencial para entender de onde vêm os campos listados nos arquivos de dados extraídos ([[Parceiros-Clientes-Fornecedores]], [[Produtos-e-Familias]], [[Vendedores]], [[Pedidos-de-Venda]], [[Notas-Fiscais-e-Itens]], [[Etapas-Faturamento]]).
...
## Ver também
- `01 - vault-modelagem-desenvolvimento/03-Sistemas-Existentes/Omie-ELT-Pipeline.md` (vault 01 — contexto completo: incidentes, decisões rejeitadas, scraper de manifesto)
- [[Etapas-Faturamento]]
- [[Perguntas-em-Aberto]]
